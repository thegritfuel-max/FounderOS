  ...
  useEffect(() => {
    ...
    return () => {
      ...
      refs.mountains.forEach(mountain => {
        ...
        if (mountain.material instanceof THREE.Material) mountain.material.dispose();
      });
        ...
        <div className="scroll-sections relative z-20">
         {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string }> = {
            0: {
              line1: 'Turn Startup Ideas Into Execution Ready Companies,',
              line2: 'Using Advanced AI Operating System'
            },
            1: {
              line1: 'Generate business plans, market research,',
              line2: 'and investor reports in minutes'
            },
            2: {
              line1: 'The complete operating system for founders,',
              line2: 'from idea to scale'
            }
          };
          
          return (
            <section key={i} className="content-section h-screen flex flex-col items-center justify-center text-center px-4 pointer-events-none">
              <h1 className="text-[10vw] font-bold text-white tracking-tighter leading-none opacity-0">
                {titles[i+1] || 'DEFAULT'}
              </h1>
          
              <div className="mt-8 space-y-2 opacity-0">
