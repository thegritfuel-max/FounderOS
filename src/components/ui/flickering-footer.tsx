...
export const siteConfig = {
  hero: {
    description: "AI assistant designed to streamline your startup journey and handle mundane tasks.",
  },
  footerLinks: [
    {
      title: "Company",
    ...
    },
    {
      title: "Products",
      links: [
        { id: 5, title: "Analysis", url: "#" },
        { id: 6, title: "Roadmap", url: "#" },
        { id: 7, title: "Finance", url: "#" },
      ],
    },
    {
      title: "Resources",
...
export const FlickeringFooter = () => {
  ...
  return (
    <footer id="footer" className="w-full pb-0 bg-white border-t border-gray-100">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between p-10 max-w-7xl mx-auto">
        <div className="flex flex-col items-start justify-start gap-y-5 max-w-xs mx-0">
          <Link to="/" className="flex items-center gap-2">
            ...
            <p className="text-xl font-bold text-gray-900">FounderOS</p>
          </Link>
        ...
        <div className="pt-5 md:w-1/2">
          <div className="flex flex-col items-start justify-start md:flex-row md:items-center md:justify-between gap-y-8 lg:pl-10">
            {siteConfig.footerLinks.map((column, columnIndex) => (
              <ul key={columnIndex} className="flex flex-col gap-y-3">
                <li className="mb-2 text-xs font-bold uppercase tracking-widest text-gray-400">
                  {column.title}
                </li>
                {column.links.map((link) => (
                  <li
                    key={link.id}
                    className="group inline-flex cursor-pointer items-center justify-start gap-1 text-[15px] font-medium text-gray-600 hover:text-primary transition-colors"
                  >
      ...
      <div className="w-full h-48 md:h-64 relative mt-12 z-0">
        ...
        <div className="absolute inset-0 mx-6">
          <FlickeringGrid
            text={tablet ? "FounderOS" : "Build the future today"}
      ...
      <div className="py-8 text-center text-xs text-gray-400 border-t border-gray-50">
        © 2026 FounderOS AI. All rights reserved.
      </div>
    </footer>
  );
};
